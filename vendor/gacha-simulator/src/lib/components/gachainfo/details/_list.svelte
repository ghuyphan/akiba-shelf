<script>
	...
	if (banner === 'weapons') {
		...
		value3star = { singlePercentage: '93.300%', avgPercentage: '83.650%', rarity: 3 };
	} else {
		...
		value3star = { singlePercentage: '94.300%', avgPercentage: '85.400%', rarity: 3 };
	}
</script>
			...
			<div class="body">
				<div class="row">
					{#each drop5star as { name, type, rateup }}
						<div class="cell">
							{merch ? (type === 'weapon' ? 'Weapon' : 'Character') : $t(type)}
						</div>
						<div class="cell">
