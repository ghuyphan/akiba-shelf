...
select lives_ok(
  format(
    ...
    (select payload -> 'session' ->> 'id' from event_result),
    '75000000-0000-4000-8000-000000000001',
    '[{"id":"76000000-0000-4000-8000-000000000001","order_code":"EVT-TEST01","customer_name":"Customer","total_amount":20000,"status":"confirmed","payment_method":"vietqr","payment_state":"bank_confirmed","fulfillment_status":"ready","fulfillment_updated_at":"2026-07-21T00:05:00Z","confirmed_by_label":"Event device 75000000","fulfillment_updated_by_label":"Event device 75000000","created_at":"2026-07-21T00:00:00Z","updated_at":"2026-07-21T00:05:00Z","items":[{"product_id":"offline-event-product","quantity":2,"unit_price":10000,"discount_amount":0}]}]'
  ),
...
select lives_ok(
  format(
    ...
    (select payload -> 'session' ->> 'id' from event_result),
    '75000000-0000-4000-8000-000000000001',
    '[{"id":"76000000-0000-4000-8000-000000000001","order_code":"EVT-TEST01","customer_name":"Customer","total_amount":20000,"status":"confirmed","payment_method":"vietqr","payment_state":"bank_confirmed","fulfillment_status":"preparing","created_at":"2026-07-21T00:00:00Z","updated_at":"2026-07-21T00:04:00Z","items":[{"product_id":"offline-event-product","quantity":2,"unit_price":10000,"discount_amount":0}]}]'
  ),
