...
export function SupportPage() {
  ...
  return (
    <div className="admin-shell platform-home-shell platform-home-landing support-page-shell">
        ...
        <section className="support-page-hero">
          <div className="support-page-hero-copy">
            <span className="support-page-kicker">
              <Heart size={15} aria-hidden="true" /> {t("Community supported")}
            </span>
            <h1>{t("Keep Matsuri free for artists.")}</h1>
            <p>
              {t(
      ...
      <footer className="platform-home-footer support-page-footer">
        ...
        <div className="platform-home-footer-meta">
          <Link to="/">{t("Back to Matsuri")}</Link>
          <small>
