...
const vi: Record<string, string> = {
  ...
  "Install the staff app for quicker access to shops and orders.": "Cài ứng dụng staff để truy cập gian hàng và đơn hàng nhanh hơn.",
  "Tap Share, then Add to Home Screen.": "Chạm Chia sẻ, sau đó chọn Thêm vào Màn hình chính.",
  ...
  "Sale price must be lower than the regular price.": "Giá khuyến mãi phải thấp hơn giá thường.",
  ...
  "We could not verify your account access. Check your connection and try again.": "Không thể xác minh quyền truy cập tài khoản. Hãy kiểm tra kết nối và thử lại.",
  "Supabase is not configured. Set VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY.": "Supabase chưa được cấu hình. Hãy đặt VITE_SUPABASE_URL và VITE_SUPABASE_ANON_KEY.",
  ...
  "Images must be between 1 byte and 10 MB.": "Ảnh phải có dung lượng từ 1 byte đến 10 MB.",
  "The image has invalid dimensions.": "Kích thước ảnh không hợp lệ.",
  "Image dimensions cannot exceed 8000 × 8000.": "Kích thước ảnh không được vượt quá 8000 × 8000.",
  "The image could not be decoded.": "Không thể giải mã ảnh.",
  "This browser cannot process the image.": "Trình duyệt này không thể xử lý ảnh.",
  "This browser cannot encode WebP images.": "Trình duyệt này không thể mã hóa ảnh WebP.",
  "The image could not be encoded.": "Không thể mã hóa ảnh.",
  "Product image variants must be WebP files.": "Các phiên bản ảnh sản phẩm phải là tệp WebP.",
  "The image could not be read.": "Không thể đọc ảnh.",
  "Push notifications are not configured. Set VITE_VAPID_PUBLIC_KEY.": "Thông báo đẩy chưa được cấu hình. Hãy đặt VITE_VAPID_PUBLIC_KEY.",
  "Select a shop before enabling notifications.": "Hãy chọn gian hàng trước khi bật thông báo.",
  "Supabase is not configured.": "Supabase chưa được cấu hình.",
  "Notification permission was not granted.": "Quyền gửi thông báo chưa được cấp.",
  "Sign in before enabling notifications.": "Hãy đăng nhập trước khi bật thông báo.",
  "English": "Tiếng Anh",
  ...
  "Matsuri turns your merch table into a friendly digital storefront, with live orders and accurate stock while you focus on meeting fans.": "Matsuri biến bàn merch của bạn thành một cửa hàng số thân thiện, với đơn hàng trực tiếp và tồn kho chính xác để bạn tập trung gặp gỡ fan.",
  ...
  "Your colors, your sections, your merch.": "Màu sắc, bố cục và merch đều là của bạn.",
  ...
  "Less table chaos. More time talking about your art.": "Bớt bối rối tại bàn. Thêm thời gian trò chuyện về tác phẩm.",
  "A simple three-step flow that feels natural for customers and helpers.": "Quy trình ba bước đơn giản, tự nhiên cho cả khách hàng và cộng sự.",
  "Fans browse": "fan xem sản phẩm",
  "They scan your booth QR, explore your collections, and add merch without blocking the table.": "Họ quét QR của gian hàng, khám phá các bộ sưu tập và thêm merch mà không làm ùn bàn.",
  "They order and pay": "Họ đặt hàng và thanh toán",
  "Matsuri reserves the items, calculates the total, and shows your VietQR payment details.": "Matsuri giữ sản phẩm, tính tổng tiền và hiển thị thông tin thanh toán VietQR.",
  "You hand it over": "Bạn giao sản phẩm",
  "The order appears live for your team, ready to confirm, pack, and give to the customer.": "Đơn hàng xuất hiện trực tiếp cho đội ngũ để xác nhận, đóng gói và giao cho khách.",
  "Your booth toolkit": "Bộ công cụ gian hàng",
  "Designed like an artist’s workspace, not an enterprise dashboard.": "Được thiết kế như không gian làm việc của artist, không phải bảng điều khiển doanh nghiệp.",
  "Use a live storefront designer, keep a simple order queue, and invite helpers without giving everyone full control.": "Thiết kế cửa hàng trực tiếp, quản lý hàng đợi đơn giản và mời cộng sự mà không cần trao toàn quyền.",
  "Arrange banners, collections, and booth information": "Sắp xếp banner, bộ sưu tập và thông tin gian hàng",
  "Use your own colors, logo, and visual style": "Dùng màu sắc, logo và phong cách riêng",
  "See pending, paid, and completed orders in one place": "Xem đơn chờ, đã thanh toán và hoàn tất tại một nơi",
  ...
  "Featured drop · Products · About the artist · Booth info": "Sản phẩm nổi bật · Sản phẩm · Về artist · Thông tin gian hàng",
  "Ready for your next event?": "Sẵn sàng cho sự kiện tiếp theo?",
  "Make a booth your fans will remember.": "Tạo một gian hàng khiến fan nhớ mãi.",
  "Create your shop": "Tạo gian hàng",
  "Made for independent artists, conventions, and pop-up booths.": "Dành cho artist độc lập, hội chợ và gian hàng pop-up.",
  "Welcome back": "Chào mừng bạn trở lại",
  "Sign in to manage your shops.": "Đăng nhập để quản lý các gian hàng.",
  "Signing in…": "Đang đăng nhập…",
  "Secure access to your shops and staff workspaces.": "Truy cập an toàn vào gian hàng và không gian làm việc của staff.",
  "Create your account": "Tạo tài khoản",
  "Start a storefront or accept a staff invitation.": "Bắt đầu một cửa hàng hoặc chấp nhận lời mời staff.",
  "Creating account…": "Đang tạo tài khoản…",
  "Email confirmation protects every new account.": "Xác nhận email giúp bảo vệ mọi tài khoản mới.",
  "Reset your password": "Đặt lại mật khẩu",
  "We’ll email a secure recovery link.": "Chúng tôi sẽ gửi liên kết khôi phục an toàn qua email.",
  "Send recovery link": "Gửi liên kết khôi phục",
  "Sending link…": "Đang gửi liên kết…",
  "Recovery never reveals whether an account exists.": "Quá trình khôi phục không tiết lộ tài khoản có tồn tại hay không.",
  ...
  "We sent a confirmation link to {{email}}.": "Chúng tôi đã gửi liên kết xác nhận đến {{email}}.",
  "If {{email}} can be recovered, a secure link is on its way.": "Nếu có thể khôi phục {{email}}, một liên kết bảo mật đang được gửi.",
  "Sending…": "Đang gửi…",
  ...
  "Secure links are short-lived and can only be used through your email.": "Liên kết bảo mật chỉ có hiệu lực trong thời gian ngắn và chỉ dùng được qua email của bạn.",
  "Show {{label}}": "Hiện {{label}}",
  "Hide {{label}}": "Ẩn {{label}}",
  "Use 10+ characters with uppercase, lowercase, and a number.": "Dùng ít nhất 10 ký tự gồm chữ hoa, chữ thường và số.",
  "Both passwords must match.": "Hai mật khẩu phải trùng khớp.",
  "Please wait a moment": "Vui lòng chờ một chút",
  "Too many emails were requested. Wait a few minutes before trying again.": "Đã yêu cầu quá nhiều email. Vui lòng chờ vài phút rồi thử lại.",
  "Too many attempts were made. Wait a few minutes before trying again.": "Đã thử quá nhiều lần. Vui lòng chờ vài phút rồi thử lại.",
  "Sign in failed": "Đăng nhập thất bại",
  "The email address or password is incorrect.": "Địa chỉ email hoặc mật khẩu không đúng.",
  "Confirm your email": "Xác nhận email",
  "Open the confirmation email before signing in.": "Mở email xác nhận trước khi đăng nhập.",
  "Use at least 10 characters with an uppercase letter, a lowercase letter, and a number.": "Dùng ít nhất 10 ký tự gồm một chữ hoa, một chữ thường và một chữ số.",
  "Link expired": "Liên kết đã hết hạn",
  "This secure link is invalid or expired. Request a new one.": "Liên kết bảo mật không hợp lệ hoặc đã hết hạn. Hãy yêu cầu liên kết mới.",
  "We could not sign you in. Check your details and try again.": "Không thể đăng nhập. Hãy kiểm tra thông tin và thử lại.",
  "Could not create account": "Không thể tạo tài khoản",
  "We could not create the account. Please try again.": "Không thể tạo tài khoản. Vui lòng thử lại.",
  "Could not send recovery email": "Không thể gửi email khôi phục",
  "We could not send the recovery email. Please try again later.": "Không thể gửi email khôi phục. Vui lòng thử lại sau.",
  "Could not finish sign in": "Không thể hoàn tất đăng nhập",
  "Could not set password": "Không thể đặt mật khẩu",
  "We could not save the password. Request a new secure link.": "Không thể lưu mật khẩu. Hãy yêu cầu liên kết bảo mật mới.",
  "Confirming your secure link…": "Đang xác nhận liên kết bảo mật…",
  "Back to sign in": "Về trang đăng nhập",
  "Expired or used secure links cannot be reopened.": "Không thể mở lại liên kết bảo mật đã hết hạn hoặc đã sử dụng.",
  "Your password is saved, but shop access could not be completed. You can retry safely.": "Mật khẩu đã được lưu nhưng chưa thể hoàn tất quyền truy cập gian hàng. Bạn có thể thử lại an toàn.",
  "Invitation not completed": "Chưa hoàn tất lời mời",
  "Shop access was accepted, but account cleanup could not finish. Retry to complete safely.": "Quyền truy cập gian hàng đã được chấp nhận nhưng chưa thể hoàn tất tài khoản. Hãy thử lại an toàn.",
  "Invitation cleanup incomplete": "Chưa hoàn tất lời mời",
  "Your password was saved, but we could not open your account. Retry safely without changing it again.": "Mật khẩu đã được lưu nhưng không thể mở tài khoản. Hãy thử lại an toàn mà không cần đổi mật khẩu lần nữa.",
  ...
  "This password link is invalid or has expired.": "Liên kết mật khẩu không hợp lệ hoặc đã hết hạn.",
  "Request another recovery email": "Yêu cầu email khôi phục khác",
  "Password links are short-lived and protected by your email session.": "Liên kết mật khẩu chỉ có hiệu lực trong thời gian ngắn và được bảo vệ bởi phiên email của bạn.",
  "Finish joining the shop": "Hoàn tất tham gia gian hàng",
  "Your password is saved. Retry the invitation without changing it again.": "Mật khẩu đã được lưu. Hãy thử lại lời mời mà không cần đổi mật khẩu lần nữa.",
  "Retry invitation": "Thử lại lời mời",
  "Your saved password will not be changed when you retry.": "Mật khẩu đã lưu sẽ không bị thay đổi khi bạn thử lại.",
  "Password updated": "Đã cập nhật mật khẩu",
  "Your new password is saved. Retry opening your account without changing it again.": "Mật khẩu mới đã được lưu. Hãy thử mở lại tài khoản mà không cần đổi mật khẩu lần nữa.",
  "Opening account…": "Đang mở tài khoản…",
  "Open my account": "Mở tài khoản của tôi",
  "Set your password": "Đặt mật khẩu",
  "Choose a secure password to finish account setup.": "Chọn mật khẩu an toàn để hoàn tất thiết lập tài khoản.",
  "New password": "Mật khẩu mới",
  "Saving…": "Đang lưu…",
  "Save password": "Lưu mật khẩu",
  "Your password is encrypted and never shown to shop staff.": "Mật khẩu được mã hóa và không bao giờ hiển thị cho staff gian hàng.",
  ...
  "Add the Supabase URL and public key before signing in.": "Thêm URL Supabase và khóa công khai trước khi đăng nhập.",
  "Open admin": "Mở trang quản trị",
  "Only authorised staff can access this workspace.": "Chỉ staff được cấp quyền mới có thể truy cập không gian này.",
  ...
  "An owner must reactivate your staff membership.": "Chủ gian hàng cần kích hoạt lại quyền staff của bạn.",
  "This signed-in account is not an authorized staff member.": "Tài khoản đang đăng nhập chưa được cấp quyền staff.",
  "Signed in as": "Đang đăng nhập bằng",
  "Ask an owner to grant this account access.": "Hãy nhờ chủ gian hàng cấp quyền cho tài khoản này.",
  "Check access again": "Kiểm tra lại quyền truy cập",
  "Shop name is required.": "Cần nhập tên gian hàng.",
  "Shop name must be between 1 and 100 characters.": "Tên gian hàng phải dài từ 1 đến 100 ký tự.",
  "Could not create shop": "Không thể tạo gian hàng",
  "Slug must be between 2 and 63 characters, contain only lowercase letters, numbers, and single dashes, and cannot start or end with a dash.": "Slug phải dài từ 2 đến 63 ký tự, chỉ gồm chữ thường, số và dấu gạch ngang đơn, đồng thời không được bắt đầu hoặc kết thúc bằng dấu gạch ngang.",
  "Could not create shop.": "Không thể tạo gian hàng.",
  "Creation failed": "Tạo gian hàng thất bại",
  "Back to shops dashboard": "Về bảng điều khiển gian hàng",
  "Back to homepage": "Về trang chủ",
  "Set up your shop name and storefront URL slug to get started.": "Thiết lập tên gian hàng và slug URL cửa hàng để bắt đầu.",
  "Shop name": "Tên gian hàng",
  "A friendly name for your merch booth.": "Tên thân thiện cho gian hàng merch của bạn.",
  "My Artist Booth": "Gian hàng artist của tôi",
  "Storefront URL slug": "Slug URL cửa hàng",
  "Only lowercase letters, numbers, and dashes. No spaces.": "Chỉ dùng chữ thường, số và dấu gạch ngang. Không dùng khoảng trắng.",
  ...
  "Select a shop workspace to manage orders, products, and designs, or preview its public storefront.": "Chọn không gian gian hàng để quản lý đơn, sản phẩm và thiết kế, hoặc xem trước cửa hàng công khai.",
  ...
  "Start a storefront only if you plan to sell your own merch. You can also wait for an invitation.": "Chỉ tạo cửa hàng nếu bạn dự định bán sản phẩm của riêng mình. Bạn cũng có thể chờ lời mời.",
  "Welcome to Matsuri": "Chào mừng đến với Matsuri",
  "You can join a shop as a teammate or create your own storefront whenever you are ready.": "Bạn có thể tham gia một gian hàng với tư cách cộng sự hoặc tạo cửa hàng riêng khi sẵn sàng.",
  "Joining someone else’s shop?": "Bạn đang tham gia gian hàng của người khác?",
  "Open the invitation link from your email. After you accept it, the shop will appear here automatically.": "Mở liên kết lời mời trong email. Sau khi chấp nhận, gian hàng sẽ tự động xuất hiện tại đây.",
  "{{owned}} of {{limit}} created shops used": "Đã dùng {{owned}} / {{limit}} gian hàng tự tạo",
  "You have joined {{joined}} shops. Joined shops do not count toward this limit.": "Bạn đã tham gia {{joined}} gian hàng. Các gian hàng tham gia không tính vào giới hạn này.",
  "Shop creation limit reached": "Đã đạt giới hạn tạo gian hàng",
  "You can create up to {{limit}} shops. Joined shops do not count toward this limit.": "Bạn có thể tạo tối đa {{limit}} gian hàng. Các gian hàng tham gia không tính vào giới hạn này.",
  "Add a new storefront and manage its inventory, custom design, and orders.": "Thêm cửa hàng mới và quản lý tồn kho, thiết kế tùy chỉnh cùng đơn hàng.",
  "Sign out of your account?": "Đăng xuất khỏi tài khoản?",
  "Your work is saved.": "Công việc của bạn đã được lưu.",
  "You’ll sign out of the platform dashboard and all shops.": "Bạn sẽ đăng xuất khỏi bảng điều khiển nền tảng và tất cả gian hàng.",
  "Cancel": "Hủy",
  "Signing out…": "Đang đăng xuất…",
  "Update the name customers see across your storefront.": "Cập nhật tên khách hàng nhìn thấy trên cửa hàng.",
  "My shop name": "Tên gian hàng của tôi",
  "Storefront URL": "URL cửa hàng",
  "Fixed": "Cố định",
  "Shop URLs cannot currently be changed after creation.": "Hiện không thể đổi URL gian hàng sau khi tạo.",
  ...
  "Fetching the latest catalog and stock levels.": "Đang tải danh mục và tồn kho mới nhất.",
  "Create your first item to start filling the booth.": "Tạo sản phẩm đầu tiên để bắt đầu lấp đầy gian hàng.",
  "Adjust your search or return to all products.": "Điều chỉnh tìm kiếm hoặc quay lại tất cả sản phẩm.",
  ...
  "Bank details and payment instructions.": "Thông tin ngân hàng và hướng dẫn thanh toán.",
  "Edit": "Sửa",
  "Bank": "Ngân hàng",
  "Account": "Tài khoản",
  "Label": "Nhãn",
  ...
  "Match payments to orders with tokens.": "Đối chiếu thanh toán với đơn hàng bằng biến.",
  "Transfer message template": "Mẫu nội dung chuyển khoản",
  "Available tokens: {code}, {item}, {amount}": "Biến có thể dùng: {code}, {item}, {amount}",
  ...
  "Name, logo, location, and social links.": "Tên, logo, vị trí và liên kết mạng xã hội.",
  "Booth": "Gian hàng",
  "Code": "Mã",
  "Hours": "Giờ mở cửa",
  ...
  "Public": "Công khai",
  "Name, code, logo, hours, and location.": "Tên, mã, logo, giờ mở cửa và vị trí.",
  ...
  "Customer-facing title and description.": "Tiêu đề và mô tả hiển thị cho khách hàng.",
  "Subtitle": "Tiêu đề phụ",
  "Social links": "Liên kết mạng xã hội",
  "Links shown in booth information.": "Các liên kết hiển thị trong thông tin gian hàng.",
  "Show": "Hiển thị",
  ...
  "Used in the center of every social QR code.": "Được đặt ở giữa mọi mã QR mạng xã hội.",
  ...
  "Add the essentials first. You can refine the listing later.": "Thêm thông tin thiết yếu trước. Bạn có thể hoàn thiện sản phẩm sau.",
  "Deleting…": "Đang xóa…",
  "Delete": "Xóa",
  "Price": "Giá",
  "Sale": "Giảm giá",
  ...
  "The information customers use to identify this item.": "Thông tin giúp khách hàng nhận biết sản phẩm.",
  ...
  "What should customers know about this item?": "Khách hàng cần biết gì về sản phẩm này?",
  "Price & availability": "Giá & tình trạng hàng",
  "Stock status updates automatically from the quantity.": "Tình trạng tồn kho tự động cập nhật theo số lượng.",
  ...
  "Large quantity — double-check this number.": "Số lượng lớn — hãy kiểm tra lại con số này.",
  "Customer badge": "Nhãn sản phẩm",
  "Optional label shown on product artwork.": "Nhãn tùy chọn hiển thị trên hình sản phẩm.",
  ...
  "Give it extra prominence on the storefront.": "Tăng độ nổi bật trên cửa hàng.",
  "Put this item on sale": "Giảm giá sản phẩm này",
  "Show a lower price while keeping the regular price visible.": "Hiển thị giá thấp hơn và vẫn giữ giá thường để khách so sánh.",
  "Visible in catalog": "Hiển thị trong danh mục",
  "Customers can find and purchase this item.": "Khách hàng có thể tìm và mua sản phẩm này.",
  "Product gallery": "Thư viện ảnh sản phẩm",
  "Add up to four images. The first image becomes the cover.": "Thêm tối đa bốn ảnh. Ảnh đầu tiên sẽ làm ảnh bìa.",
  "Product": "Sản phẩm",
  "Cover": "Ảnh bìa",
  ...
  "This order was already handled by another staff member.": "Đơn này đã được staff khác xử lý.",
  ...
  "Cancel this order? This cannot be undone.": "Hủy đơn này? Không thể hoàn tác thao tác này.",
  ...
  "{{first}}–{{last}} of {{total}} · newest first": "{{first}}–{{last}} trên {{total}} · mới nhất trước",
  "Loading orders…": "Đang tải đơn hàng…",
  "No orders yet": "Chưa có đơn hàng",
  "No {{status}} orders": "Không có đơn {{status}}",
  "Fetching the latest queue from the server.": "Đang tải hàng đợi mới nhất từ máy chủ.",
  "You’re all caught up. New orders will appear here automatically.": "Bạn đã xử lý hết. Đơn mới sẽ tự động xuất hiện tại đây.",
  "There are no orders with this status yet.": "Chưa có đơn hàng ở trạng thái này.",
  ...
  "Swipe right or press Enter to confirm payment and update stock": "Vuốt sang phải hoặc nhấn Enter để xác nhận thanh toán và cập nhật tồn kho",
  ...
  "Payment confirmed and stock updated": "Đã xác nhận thanh toán và cập nhật tồn kho",
  "Confirmation failed. Try again.": "Xác nhận thất bại. Hãy thử lại.",
  "Staff": "staff",
  "Admin": "Quản trị viên",
  "Owner": "Chủ sở hữu",
  "Process and fulfil orders": "Xử lý và hoàn tất đơn hàng",
  "Manage catalog, settings, and orders": "Quản lý danh mục, cài đặt và đơn hàng",
  ...
  "Invite processed. The team list is up to date.": "Đã xử lý lời mời. Danh sách đội ngũ đã được cập nhật.",
  ...
  "Invite people, choose their role, and review access in one place.": "Mời mọi người, chọn vai trò và xem lại quyền truy cập tại một nơi.",
  ...
  "Choose what they can do. You can change or remove access later.": "Chọn quyền họ có thể sử dụng. Bạn có thể thay đổi hoặc xóa quyền sau.",
  "Track who still needs to accept their email invitation.": "Theo dõi những người vẫn cần chấp nhận lời mời qua email.",
  "They’ll receive secure access for this shop only.": "Họ sẽ nhận quyền truy cập an toàn chỉ dành cho gian hàng này.",
  "{{used}} of {{limit}} team places used": "Đã dùng {{used}} / {{limit}} vị trí trong đội ngũ",
  "Team limit reached": "Đã đạt giới hạn đội ngũ",
  "Shop team limit reached.": "Gian hàng đã đạt giới hạn 10 thành viên và lời mời đang chờ.",
  "Revoke a pending invitation or remove a member before inviting someone new.": "Hãy thu hồi một lời mời đang chờ hoặc xóa một thành viên trước khi mời người mới.",
  "Email": "Email",
  "Role": "Vai trò",
  "Invitation role": "Vai trò lời mời",
  "Send invitation": "Gửi lời mời",
  "Members": "Thành viên",
  "{{count}} people with shop access": "{{count}} người có quyền truy cập gian hàng",
  ...
  "Ownership changes affect full shop and team access. The shop must always retain at least one active owner.": "Thay đổi chủ sở hữu ảnh hưởng toàn bộ quyền gian hàng và đội ngũ. Gian hàng luôn phải có ít nhất một chủ sở hữu đang hoạt động.",
  "Confirm change": "Xác nhận thay đổi",
  "Remove shop access?": "Xóa quyền truy cập gian hàng?",
  "will immediately lose access to this shop.": "sẽ mất quyền truy cập gian hàng này ngay lập tức.",
  ...
  "Location, hours, and social QR codes": "Vị trí, giờ mở cửa và mã QR mạng xã hội",
  "Browse controls": "Điều khiển duyệt",
  "Categories, search, sort, and view mode": "Danh mục, tìm kiếm, sắp xếp và kiểu xem",
  "Shopping cart": "Giỏ hàng",
  "Cart, bank details, transfer note, and QR": "Giỏ hàng, thông tin ngân hàng, nội dung chuyển khoản và QR",
  ...
  "Click anything in the preview to edit it.": "Nhấp vào nội dung trong bản xem trước để chỉnh sửa.",
  ...
  "Wide and side modules keep safe column widths. Dragging changes their order within those responsive lanes.": "Mô-đun rộng và bên cạnh luôn giữ chiều rộng cột an toàn. Kéo để đổi thứ tự trong các vùng đáp ứng tương ứng.",
  "Only settings for the selected section are shown.": "Chỉ hiển thị cài đặt của phần đang chọn.",
  "The Featured banner displays details directly from active featured products. Mark products as Featured in the Products workspace.": "Banner Nổi bật lấy nội dung trực tiếp từ các sản phẩm nổi bật đang hoạt động. Đánh dấu sản phẩm là Nổi bật trong khu vực Sản phẩm.",
  "Auto-rotate products": "Tự động chuyển sản phẩm",
  "Advance to the next featured item every 4.5 seconds. Pauses after customer interaction and respects reduced motion.": "Chuyển sang sản phẩm nổi bật tiếp theo sau mỗi 4,5 giây. Tạm dừng sau tương tác và tôn trọng cài đặt giảm chuyển động.",
  ...
  "Browse controls use the categories and product data from your catalog. Language is available under Style.": "Điều khiển duyệt dùng danh mục và dữ liệu sản phẩm. Ngôn ngữ nằm trong mục Phong cách.",
  "Product content is managed from the Products workspace. This section follows the customer’s grid or list choice.": "Nội dung sản phẩm được quản lý trong khu vực Sản phẩm. Phần này tuân theo lựa chọn dạng lưới hoặc danh sách của khách.",
  "Look & feel": "Giao diện",
  "Palette presets": "Bảng màu có sẵn",
  "Start with a mood, then fine-tune any color below.": "Bắt đầu với một phong cách, sau đó tinh chỉnh từng màu bên dưới.",
  ...
  "Choose how product, booth, cart, and control cards feel.": "Chọn phong cách cho thẻ sản phẩm, gian hàng, giỏ hàng và điều khiển.",
  "Soft": "Mềm mại",
  ...
  "Make this palette completely yours.": "Biến bảng màu này thành phong cách riêng của bạn.",
  "Changes update the canvas instantly.": "Thay đổi cập nhật bản xem trước ngay lập tức.",
  "Primary": "Chính",
  "Dark": "Tối",
  "Accent": "Điểm nhấn",
  ...
  "Could not load workspace data.": "Không thể tải dữ liệu không gian làm việc.",
  ...
  "Order notifications enabled on this device.": "Đã bật thông báo đơn hàng trên thiết bị này.",
  ...
  "Confirm payments and fulfil orders.": "Xác nhận thanh toán và hoàn tất đơn hàng.",
  "Manage products, prices, and stock.": "Quản lý sản phẩm, giá và tồn kho.",
  "Update booth and payment details.": "Cập nhật thông tin gian hàng và thanh toán.",
  "Build your storefront and checkout.": "Thiết kế cửa hàng và quy trình thanh toán.",
  ...
  "We could not load this shop's workspace. Check your connection and retry.": "Không thể tải không gian của gian hàng này. Hãy kiểm tra kết nối và thử lại.",
  ...
  "Choose a product from the list to edit it, or start a fresh listing.": "Chọn sản phẩm trong danh sách để chỉnh sửa hoặc tạo sản phẩm mới.",
  ...
  "You’ll return to the staff login screen. The public catalog stays open for customers.": "Bạn sẽ quay lại màn hình đăng nhập staff. Danh mục công khai vẫn mở cho khách hàng.",
  "Stay signed in": "Tiếp tục đăng nhập",
  "Gacha": "Gacha",
  "Gacha banners": "Banner gacha",
  "Build merch pools, preview changes, then publish.": "Tạo pool merch, xem thử thay đổi rồi xuất bản.",
  "Banners": "Banner",
  "Add, order, duplicate, or disable banners.": "Thêm, sắp xếp, nhân bản hoặc tắt banner.",
  ...
  "Banner presentation, pool, and item stats.": "Giao diện banner, pool và chỉ số vật phẩm.",
  ...
  "Shared availability and pity across every banner.": "Trạng thái và bảo hiểm dùng chung cho mọi banner.",
  ...
  "featured": "nổi bật",
  "Add": "Thêm",
  "Preparing the shop’s merch banners.": "Đang chuẩn bị các banner merch của gian hàng.",
  "Give the minigame and every banner a title.": "Hãy đặt tên cho minigame và mọi banner.",
  "Every active banner needs at least one active merch item.": "Mỗi banner đang bật cần ít nhất một merch đang hoạt động.",
  "Featured slots are full": "Đã đủ vị trí nổi bật",
  "This banner can show up to {{count}} featured items.": "Banner này có thể hiển thị tối đa {{count}} vật phẩm nổi bật.",
  "Sword": "Kiếm",
  "Claymore": "Trọng kiếm",
  ...
  "Turn your merch into characters and weapons for a free minigame.": "Biến merch thành nhân vật và vũ khí trong minigame miễn phí.",
  "Shelf wishes": "Điều ước kệ hàng",
  "Create a free character-and-weapon minigame using your real merch catalog.": "Tạo minigame nhân vật và vũ khí miễn phí từ danh mục merch thật.",
  ...
  "Only staff can preview it until you open it.": "Chỉ staff có thể xem thử cho đến khi bạn mở minigame.",
  "Open": "Đang mở",
  "Closed": "Đã đóng",
  ...
  "Guarantee a 4-star or higher within this many pulls.": "Đảm bảo nhận 4 sao trở lên trong số lượt này.",
  "Guarantee a 5-star within this many pulls.": "Đảm bảo nhận 5 sao trong số lượt này.",
  "Merch wish pool": "Pool điều ước merch",
  "Choose products, present them as characters or weapons, and tune their rarity.": "Chọn sản phẩm, đặt vai trò nhân vật hoặc vũ khí và điều chỉnh độ hiếm.",
  ...
  "Try another product name, code, or category.": "Hãy thử tên, mã hoặc danh mục sản phẩm khác.",
  ...
  "The 5-star pity must be higher than the 4-star pity.": "Bảo hiểm 5 sao phải lớn hơn bảo hiểm 4 sao.",
  "Add at least one active merch item before opening the minigame.": "Thêm ít nhất một merch đang hoạt động trước khi mở minigame.",
...
export function PlatformI18nProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo<PlatformI18nValue>(() => ({
    ...
    t(english, variables) {
      return interpolate(locale === "vi" ? (vi[english] ?? english) : english, variables);
    },
  }), [locale]);
...
export function usePlatformI18n() {
  ...
  if (!value) throw new Error("usePlatformI18n must be used inside PlatformI18nProvider");
  return value;
}

export function getPlatformTranslation(english: string, locale: PlatformLocale, variables?: Variables) {
  return interpolate(locale === "vi" ? (vi[english] ?? english) : english, variables);
}
