...
const vi: Record<string, string> = {
  ...
  "Access request processed.": "Đã xử lý yêu cầu truy cập.",
  ...
  "Shop staff": "staff gian hàng",
  "Invite teammates and control access to this shop.": "Mời cộng sự và kiểm soát quyền truy cập gian hàng này.",
