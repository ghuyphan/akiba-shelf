...
export const GACHA_GAME_TYPES = ["genshin", "hsr"] as const satisfies readonly GachaGameType[];
...
const hsrElements: GachaElementMeta[] = [
  { id: "physical", color: "#9aa2af", visual: { type: "image", src: hsrPhysicalIcon } },
  { id: "fire", color: "#f2615a", visual: { type: "image", src: hsrFireIcon } },
  { id: "ice", color: "#4bc2f1", visual: { type: "image", src: hsrIceIcon } },
  { id: "lightning", color: "#d772f1", visual: { type: "image", src: hsrLightningIcon } },
  { id: "wind", color: "#51eb99", visual: { type: "image", src: hsrWindIcon } },
  { id: "quantum", color: "#7c55f1", visual: { type: "image", src: hsrQuantumIcon } },
  { id: "imaginary", color: "#f1ca4b", visual: { type: "image", src: hsrImaginaryIcon } },
];
...
export const GACHA_GAMES: Record<GachaGameType, GachaGameDescriptor> = {
  ...
  hsr: {
    ...
    displayLimitMax: 4,
    featuredRule: { kind: "primary-secondary", primaryLimit: 1, secondaryLimit: 3 },
    defaults: {
      title: "Warp upon the shelf",
      description: "Discover a featured character or Light Cone from this shop.",
      legendaryPity: 90,
