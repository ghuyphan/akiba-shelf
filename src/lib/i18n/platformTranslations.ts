...
const vi: Record<string, string> = {
  ...
  "Booth card style": "Kiểu thẻ gian hàng",
  "Full identity card and QR codes": "Thẻ đầy đủ thông tin và mã QR",
  "Social icon links and space saving": "Biểu tượng mạng xã hội gọn gàng, tiết kiệm không gian",
  Banner: "Biểu ngữ",
  "Centered hero identity with accent": "Thương hiệu căn giữa với dải màu nổi bật",
  "Themed borders and offset tags": "Viền chủ đề và thẻ bóng lệch",
  "Cart card style": "Kiểu thẻ giỏ hàng",
  "Standard card and full line items": "Thẻ chuẩn với danh mục sản phẩm đầy đủ",
  "Dense rows for multi-item orders": "Hàng rút gọn cho đơn hàng nhiều món",
  "Themed surface and pop action dock": "Bề mặt chủ đề và nút thanh toán nổi bật",
  Classic: "Cổ điển",
