...
import { boothSettingsSchema, imageVariantSchema, layoutOrderSchema, orderMutationSchema, promotionSettingsSchema, salesSummarySchema } from "../schemas";
...
describe("runtime schemas", () => {
  ...
  it("accepts Postgres timestamp offsets", () => {
    expect(promotionSettingsSchema.shape.starts_at.parse("2026-07-29T15:00:00+00:00")).toBe("2026-07-29T15:00:00+00:00");
    expect(salesSummarySchema.shape.from.parse("2026-07-29T15:00:00+00:00")).toBe("2026-07-29T15:00:00+00:00");
  });
});
