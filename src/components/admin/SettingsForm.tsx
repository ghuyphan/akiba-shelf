...
export function SettingsForm({ settings, onSave }: SettingsFormProps) {
  ...
  return (
    <AdminCard title="Booth information" description="Manage the identity and information customers use to find your booth." icon={<Store size={18} />} action={!isEditing ? <Button type="button" variant="secondary" icon={<Edit3 size={17} />} onClick={() => setIsEditing(true)}>Edit settings</Button> : undefined}>
