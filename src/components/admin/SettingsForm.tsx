...
export function SettingsForm({ shopId, settings, onSave }: SettingsFormProps) {
  ...
  return (
    <AdminCard title="Booth info" description="Name, logo, location, and social links." icon={<Store size={18} />} action={!isEditing ? <Button type="button" variant="secondary" icon={<Edit3 size={17} />} onClick={() => setIsEditing(true)}>Edit</Button> : undefined}>
      <form className="admin-form" onSubmit={handleSubmit}>
        ...
        <section className="admin-form-section">
          <div className="admin-form-section-heading"><span><Type size={15} /></span><div><h3>Store copy</h3><p>Customer-facing title and description.</p></div></div>
