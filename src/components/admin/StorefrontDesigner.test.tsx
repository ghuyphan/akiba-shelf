...
vi.mock("../catalog/CatalogHeader", () => ({ CatalogHeader: () => null }));
vi.mock("../catalog/CategoryFilters", () => ({ CategoryFilters: () => null }));
vi.mock("../catalog/CatalogToolbar", () => ({ CatalogToolbar: () => null }));
vi.mock("../catalog/ProductGrid", () => ({ ProductGrid: () => null }));
vi.mock("../catalog/StackedFeatured", () => ({ StackedFeatured: () => null }));
vi.mock("../catalog/BoothInfoPanel", () => ({ BoothInfoPanel: () => null }));
vi.mock("../catalog/SelectedItemPanel", () => ({ SelectedItemPanel: () => null }));
